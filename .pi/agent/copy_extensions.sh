cp ~/dev/pi-mono/packages/coding-agent/examples/extensions/todo.ts ~/.pi/agent/extensions/todo.ts
cp ~/dev/pi-mono/packages/coding-agent/examples/extensions/question.ts ~/.pi/agent/extensions/question.ts
cp ~/dev/pi-mono/packages/coding-agent/examples/extensions/questionnaire.ts ~/.pi/agent/extensions/questionnaire.ts
