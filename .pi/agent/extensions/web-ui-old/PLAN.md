# Pi Web UI (archived) — historical large-session and browser-quality plan

> Historical only. New implementation work is tracked in [`../web-ui/PLAN.md`](../web-ui/PLAN.md). This directory is a donor of bounded algorithms and fixtures, not an active product.
