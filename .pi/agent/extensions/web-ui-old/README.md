...
> This is the retired richer implementation retained as a reference donor. The canonical extension is [`../web-ui/`](../web-ui/). It remains disabled in `.pi/agent/settings.json` and should not receive new product work.
