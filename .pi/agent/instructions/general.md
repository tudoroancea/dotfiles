...
- Delete `PLAN.md` once the plan has been entirely carried out.
...
- If the commit is big enough to warrant explanations, put them in the commit description not title.
